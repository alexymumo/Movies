...
sealed class NavigationItem(
    ...
    object Popular : NavigationItem("popular", R.drawable.ic_upcoming, R.string.popular)
    object TopRated : NavigationItem("toprated", R.drawable.ic_toprated, R.string.toprated)
